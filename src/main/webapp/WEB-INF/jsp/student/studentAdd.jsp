...
<html>
    ...
    <body>
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="phoneHome" name="phoneHome" placeholder="Phone Home" value="${phoneHome}" required />
	  </div>
	  <div class="form-group">
	    <label for="phoneMobile">Phone Mobile</label>
	    <input type="text" class="form-control" id="phoneMobile" name="phoneMobile" placeholder="Phone Mobile" value="${phoneMobile}" required />
	  </div>
